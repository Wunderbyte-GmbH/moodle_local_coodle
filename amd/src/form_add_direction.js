...
const ACTIONS = {
    ...
    EDIT_DIRECTION: 'local-coodle-edit-direction',
};
    ...
    document.querySelector(SELECTORS.LINK).addEventListener('click', function(e) {
        ...
        switch (target.dataset.action) {
            case ACTIONS.ADD_DIRECTION:
                e.stopPropagation();
                title = getString('add_direction', 'local_coodle');
                openForm(e);
                break;
            case ACTIONS.EDIT_DIRECTION:
                e.stopPropagation();
                title = 'test';
                openForm(e);
                break;
 ...
 */
 const openForm = event => {
    ...
    let directionid = button.dataset.directionid || null;
