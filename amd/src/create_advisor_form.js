...
const SELECTORS = {
    CREATE_ADVISOR: '[data-action="coodle-create_advisor_form"]',
};
...
export const init = () => {
    ...
    // Find all container.
    const containers = document.querySelectorAll(SELECTORS.CREATE_ADVISOR);
 ...
 */
 const openForm = event =>{
    ...
    const modalForm = new ModalForm({
        ...
        formClass: "local_coodle\\form\\create_advisor_form",
        // Add as many arguments as you need, they will be passed to the form:
        args: {
            'nobuttons': true
        },
        // Pass any configuration settings to the modal dialogue, for example, the title:
        modalConfig: {title: getString('createadvisor', 'local_coodle')},
